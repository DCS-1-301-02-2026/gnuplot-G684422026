...
set grid
plot "weather2026.csv" using 1:2 title "最高気温" with lines,"" using 1:3 title "最高気温(平年)" with lines,"" using 1:4 title "最低気温" with lines,"" using 1:5 title "最低気温(平年)" with lines 
```
